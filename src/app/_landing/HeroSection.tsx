...
export function HeroSection({ onAnalyze, loading, activeRepo, error }: Props) {
  ...
  return (
    <section className="max-w-6xl mx-auto px-6 pt-16 pb-12 text-center">
      ...
      <h1 className="text-5xl sm:text-6xl font-black text-zinc-900 tracking-tight leading-[1.06] mb-5">
      ...
      <div className="max-w-2xl mx-auto">
        <form
          ...
          className="flex gap-2 bg-white border border-zinc-200 rounded-2xl p-2 shadow-[0_4px_24px_rgb(0,0,0,0.07)] focus-within:border-zinc-400 focus-within:shadow-[0_8px_32px_rgb(0,0,0,0.10)] transition-all"
        >
          ...
          <button
            ...
            className="shrink-0 bg-zinc-900 text-white text-sm font-bold rounded-xl px-6 py-3 hover:bg-zinc-700 disabled:opacity-40 disabled:cursor-not-allowed transition-all active:scale-95"
          >
            {loading && !activeRepo ? (
